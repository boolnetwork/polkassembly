				...
				<div
					className={`${
						isUsedInTreasuryTrack
							? 'flex'
							: 'ml-[-37px] flex min-w-[290px] cursor-pointer items-center justify-center rounded-[8px] align-middle text-[35px] text-lightBlue transition delay-150 duration-300 hover:bg-[#ef5a1912] hover:text-bodyBlue dark:text-blue-dark-medium'
					}`}
					onClick={handleClick}
				>
					{isUsedInTreasuryTrack ? (
